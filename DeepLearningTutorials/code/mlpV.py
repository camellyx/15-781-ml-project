...
class HiddenLayer(object):
    def __init__(self, rng, input, sigma, n_in, n_out, W=None, b=None,
                 activation=T.tanh):
        """
        ...
        :type sigma: float
        :param sigma: standard variation in normal distribution
        ...
        #### variation ####
        output_mask = srng.normal((n_in,n_out),0, sigma)
...
class MLP(object):
    ...
    def __init__(self, rng, input, sigma, n_in, n_hidden, n_out):
...
def test_mlp(sigma = 0.01, learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001,
