...
class HiddenLayer(object):
    def __init__(self, rng, input, p, n_in, n_out, W=None, b=None,
                 activation=T.tanh):
        """
        ...
        #### dropconnect ####
        srngC = RandomStreams(seed=930508)
        output_mask = srngC.binomial((n_in,n_out),1,p)
        ...
        #### dropout ####
        srngO = RandomStreams(seed=930508)
        output_mask = srngO.binomial((n_out,),1,p)
