...
class LeNetConvPoolLayer(object):
    ...
    def __init__(self, rng, input, sigma,filter_shape, image_shape, poolsize=(2, 2)):
        """
...
def evaluate_lenet5(sigma = 0.01, learning_rate=0.1, n_epochs=200,
...
if __name__ == '__main__':
  # default : evaluate_lenet5(sigma = 0.01)
    evaluate_lenet5(sigma = 0.05)
